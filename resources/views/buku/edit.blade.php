...
<div class="content-wrapper">
    ...
    <div class="card">
        ...
        <div class="card-body table-responsive p-0">
            <form class="form-horizontal" action="/buku/{{$buku->id}}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="{{$buku->kode}}" id="inputEmail3" name="kode">
                    </div>
                  </div>
                  <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control" value="{{$buku->status}}" id="inputEmail3" name="status">
                              </div>
                            </div>
                <!-- /.card-body -->
