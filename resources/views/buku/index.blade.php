        ...
        <div class="card-body table-responsive p-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$item->status}}</td>
                        <td>
                            <a href="/buku/edit/{{$item->id}}" class="btn btn-sm text-white btn-info"><i class="fa fa-pencil-alt"></i></a>
                                  ...
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        Yakin ingin menghapus Buku <b>{{$item->kode}}-{{$item->judul}}</b> ?
                                      </div>
                                      <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                        <form method="POST" action="/buku/{{$item->id}}">
                                          @csrf
                                          @method('DELETE')
