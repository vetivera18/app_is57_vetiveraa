            ...
            <form class="form-horizontal" action="/peminjaman/{{$peminjaman->id}}" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="date" class="form-control" id="inputPassword3" value="{{$peminjaman->tgl_pinjam}}" name="tgl_pinjam">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Tanggal Kembali</label>
                    <div class="col-sm-10">
                      <input type="date" class="form-control" id="inputPassword3" value="{{$peminjaman->tgl_kembali}}" name="tgl_kembali">
                    </div>
                  </div>
                  <div class="form-group row">
